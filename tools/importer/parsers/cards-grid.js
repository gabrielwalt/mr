 ...
 * Base Block: cards (default)
 *
 * Converts card grid sections into EDS Cards block table format.
 * Unlike carousel-default.js which outputs a Carousel block,
 * this parser outputs a Cards block for grid-based card layouts.
 *
